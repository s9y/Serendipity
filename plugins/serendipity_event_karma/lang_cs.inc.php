...
@define('PLUGIN_KARMA_NOCOOKIE',                    'Váš prohlížeè musí podporovat cookies. jinak nemùžete hlasovat.');
@define('PLUGIN_KARMA_CLOSED',                      'Hodnocení èlánku novìjší než %s dní!');
...
@define('PLUGIN_KARMA_TIMEOUT',                     'Ochrana proti zahlcením serveru: Jiný ètenáø právì hlasoval. Poèkejte pøed Vaším hlasování %s minut, prosím.');
...
@define('PLUGIN_KARMA_MAXKARMA_BLAHBLAH',           'Povolit hlsování karmy pro èlánek, který je mladší než X dní (Standardnì: 7)');
...
@define('PLUGIN_KARMA_VISITS_BLAHBLAH',             'Má být každé klinkutí na zobrazení rozšíøené textové èásti poèítáno a zaznamenáváno?');
...
@define('PLUGIN_KARMA_VISITS_LOGGEDIN_USERS',       'Sledovat návštìvy pøihlášených uživatelù?');
@define('PLUGIN_KARMA_VISITS_LOGGEDIN_USERS_BLAHBLAH', 'Pokud je tato volba povolena, návštìvy uživatelù, kteøí jsou pøihlášeni, jsou také zaznamenávány. (Takovými užiateli jste napøíklad vy pøi zadávání nových pøípìvkù a jejich odlaïování)');
?>
