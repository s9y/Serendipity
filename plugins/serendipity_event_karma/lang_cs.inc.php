...
/**
 *  @file lang_cs.inc.php 1475.0 2012-02-17 22:39:24 VladaAjgl
...
@define('PLUGIN_KARMA_AJAX_BLAHBLAH', 'Má se hlasování provádìt pomocí asynchronního javascriptu? Pokud je nastavené "Ano", bude se hlasování odesílat na server na pozadí stránky a vısledek bude aktualizován bez znovunaètení stránky blogu.');
@define('PLUGIN_KARMA_ALIGNMENT', 'Zarovnání pluginu');
@define('PLUGIN_KARMA_ALIGNMENT_BLAHBLAH', 'Má bıt plugin zarovnán doleva, na støed nebo doprava');
