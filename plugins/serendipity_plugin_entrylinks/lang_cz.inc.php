...
@define('PLUGIN_ENTRYLINKS_WORDWRAP_BLAHBLAH',  'Po kolika znacích má být vlo¾eno zalomení textu (aby dlouhé odkazy nenatahovaly postranní sloupec)? (Standardnì: 30)');
@define('PLUGIN_ENTRYLINKS_MAXREF',             'Maximální poèet odkazù');
@define('PLUGIN_ENTRYLINKS_MAXREF_BLAHBLAH',    'Kolik odkazù má být nanejvý¹ zobrazeno? (Standardnì: 15)');
