...
@define('PLUGIN_EVENT_ENTRYPROPERTIES_CACHE_BUILDING', 'Building cache for entryŞu yazı için önbellekleme işlemi: #%d, <em>%s</em>...');
...
@define('PLUGIN_EVENT_ENTRYPROPERTIES_GROUPS_DESC', 'Eğer bu seçenek etkinleştirilirse, hangi kullanıcı grubunun kullanıcılarının bu yazıyı okuma yetkisi olduğunu belirleyebilirsiniz. Bu seçenek performansı olumsuz etkileyebilir. Sadece gerçekten ihtiyacınız varsa bu seçeneği etkinleştirmeniz önerilir.');
@define('PLUGIN_EVENT_ENTRYPROPERTIES_USERS', 'Kullanıcı tabanlı yetkilendirme kullan');
@define('PLUGIN_EVENT_ENTRYPROPERTIES_USERS_DESC', 'Eğer bu seçenek etkinleştirilirse, Bu yazıyı okuma izni olan özel kullanıcıları tanımlayabilirsiniz. Bu seçenek performansı olumsuz etkileyebilir. Sadece gerçekten ihtiyacınız varsa bu seçeneği etkinleştirmeniz önerilir.');
