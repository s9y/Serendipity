...
$template_config = array(
    ...
    array(
        ...
        'select_values' => array(DATE_FORMAT_ENTRY => DATE_FORMAT_ENTRY . ' (' . strftime(DATE_FORMAT_ENTRY) .')',
                                '%A, %e. %B %Y' => '%A, %e. %B %Y (' . strftime('%A, %e. %B %Y') . ')',
                                '%a, %e. %B %Y' => '%a, %e. %B %Y (' . strftime('%a, %e. %B %Y') . ')',
                                '%e. %B %Y' => '%e. %B %Y (' . strftime('%e. %B %Y') . ')',
                                '%d.%m.%y' => '%d.%m.%y (' . strftime('%d.%m.%y') . ')',
                                '%d.%m.%Y' => '%d.%m.%Y (' . strftime('%d.%m.%Y') . ')',
                                '%A, %m/%d/%Y' => '%A, %m/%d/%Y (' . strftime('%A, %m/%d/%Y') . ')',
                                '%a, %m/%d/%y' => '%a, %m/%d/%y (' . strftime('%a, %m/%d/%y') . ')',
                                '%m/%d/%y' => '%m/%d/%y (' . strftime('%m/%d/%y') . ')',
                                '%m/%d/%Y' => '%m/%d/%Y (' . strftime('%m/%d/%Y') . ')',
                                '%Y-%m-%d' => '%Y-%m-%d (' . strftime('%Y-%m-%d') . ')',
                                '%A, %e. %B %Y %H:%M' => '%A, %e. %B %Y %H:%M (' . strftime('%A, %e. %B %Y %H:%M') . ')',
                                '%a, %e. %B %Y %H:%M' => '%a, %e. %B %Y %H:%M (' . strftime('%a, %e. %B %Y %H:%M') . ')',
                                '%e. %B %Y %H:%M' => '%e. %B %Y %H:%M (' . strftime('%e. %B %Y %H:%M') . ')',
                                '%d.%m.%y %H:%M' => '%d.%m.%y %H:%M (' . strftime('%d.%m.%y %H:%M') . ')',
                                '%d.%m.%Y %H:%M' => '%d.%m.%Y %H:%M (' . strftime('%d.%m.%Y %H:%M') . ')',
                                '%A, %m/%d/%Y %H:%M' => '%A, %m/%d/%Y %H:%M (' . strftime('%A, %m/%d/%Y %H:%M') . ')',
                                '%a, %m/%d/%y %H:%M' => '%a, %m/%d/%y %H:%M (' . strftime('%a, %m/%d/%y %H:%M') . ')',
                                '%m/%d/%y %H:%M' => '%m/%d/%y %H:%M (' . strftime('%m/%d/%y %H:%M') . ')',
                                '%m/%d/%Y %H:%M' => '%m/%d/%Y %H:%M (' . strftime('%m/%d/%Y %H:%M') . ')',
                                '%Y-%m-%d %H:%M' => '%Y-%m-%d %H:%M (' . strftime('%Y-%m-%d %H:%M') . ')',
            )
    ),
    array(
        'var' => 'header_img',
