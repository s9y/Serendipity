...
@define('BACKEND_TITLE_FOR_NUGGET', 'Zde mù¾ete definovat svùz øetìzec, který bude zobrazen v konfiguraèní obrazovce pluginu spoleènì s popisem pluginu HTML Nugget. If you have multiple HTML nuggets with an empty title, this helps to distinct the plugins from another.'); // Translate
