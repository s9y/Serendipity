...
@define('BACKEND_TITLE_FOR_NUGGET', 'Zde mùete definovat svùz øetìzec, kterı bude zobrazen v konfiguraèní obrazovce pluginu spoleènì s popisem pluginu HTML Nugget. If you have multiple HTML nuggets with an empty title, this helps to distinct the plugins from another.'); // Translate
...
@define('USERCONF_GROUPS_DESC', 'Tento uivatel je èlen následujících skupin. èlenství ve více skupinách je moná.');
