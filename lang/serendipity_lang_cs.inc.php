...
@define('INSTALL_PERMALINK_CATEGORY_DESC', 'Zde mùete definovat relativní strukturu URL, kde zaèátek je vaše base URL, z ní mohou bıt dostupné urèité kategorie. Mùete pouít promìnné  %id%, %name%, %description% a jakékoli jiné znaky.');
