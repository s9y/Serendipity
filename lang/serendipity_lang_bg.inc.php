...
@define('INSTALL_CHARSET_DESC', 'Тук можете да превключвате между местно кодиране (ISO, EUC, ...) или UTF-8. Някои езици имат само превод в UTF-8 и задаването на "Местно" няма да има ефект. Препоръчва се UTF-8 за нови инсталации. Не променяйте тази настройка, ако вече имате статии със специални знаци - това може да доведе до развалени знаци. Добре е да прочетете повече за този проблем в https://www.s9y.org/index.php?node=46.');
