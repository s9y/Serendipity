 ...
 *  Translation (c) 2010-2012 Martin Matuška <martin@matuska.org>
 */
...
@define('DATE_LOCALES',		'sk_SK.UTF-8, slovak, sk');
@define('DATE_FORMAT_ENTRY',		'%A, %e. %B %Y');
@define('DATE_FORMAT_SHORT',		'%d.%m.%Y %H:%M');
@define('WYSIWYG_LANG',		'sk-utf');
...
@define('SUBSCRIBE_TO_THIS_ENTRY',		'Prihlásiť sa k sledovaniu komentárov tohto článku');
