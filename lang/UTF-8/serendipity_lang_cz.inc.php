<?php # $Id: serendipity_lang_cz.inc.php 1460 2006-10-26 20:05:04Z garvinhicking $
...
@define('BACKEND_TITLE_FOR_NUGGET', 'Zde můžete definovat svůz řetězec, který bude zobrazen v konfigurační obrazovce pluginu společně s popisem pluginu HTML Nugget. If you have multiple HTML nuggets with an empty title, this helps to distinct the plugins from another.'); // Translate
...
@define('USERCONF_GROUPS_DESC', 'Tento uživatel je člen následujících skupin. členství ve více skupinách je možná.');
