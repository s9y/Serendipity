<?php # $Id: serendipity_lang_zh.inc.php 2353 2008-10-18 10:27:41Z garvinhicking $
...
@define('INSTALL_PERMALINK_CATEGORY_DESC', '这里可以让你设定以基本位置来计算文章的相对连接。你可以用以下参数：%id%, %name%, %description% 或其它字符。');
