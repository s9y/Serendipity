...
@define('NOTIFICATION_CONFIRM_SUBMAIL_FAIL', 'Вашият абонамент за известия за коментари не може да бъде потвърден. Моля проверете връзката, която сте избрали. Ако връзката е била изпратена преди повече от три седмици, Вие трябва да поискате нов email за потвърждение.');
