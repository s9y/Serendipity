...
@define('WRONG_USERNAME_OR_PASSWORD', 'Úgy tűnik, hogy hibás felhasználónevet vagy jelszót adtál meg');
...
@define('WARNING_THIS_BLAHBLAH', "FIGYELEM:\\nEz sokáig eltarthat, ha csak kevés képnek van előnézei képe.");
...
@define('ADD_COMMENT', 'Megjegyzés Hozzáfűzése');
...
@define('COMMENTS_CLOSED', 'A szerző letiltotta a megjegyzések hozzáadását.');
...
@define('BROWSER_RELOAD', 'Ha kész vagy, katints a böngésző "Frissítés" gombjára.');
...
@define('SYNDICATION_PLUGIN_MANAGINGEDITOR_DESC', 'A Főszerkesztő emil címe, ha van. (üres: rejtett) [RSS 2.0]');
...
@define('SYNDICATION_PLUGIN_TTL_DESC', 'Az az időtartam (percben), ami után a blogodat nem cache-elje többé semmilyen külső honlap vagy alkalmazás (üres: rejtett) [RSS 2.0]');
@define('SYNDICATION_PLUGIN_PUBDATE', '"Publikáció Dátuma" mező');
@define('SYNDICATION_PLUGIN_PUBDATE_DESC', 'Szerepeljen a "Publikáció Dátuma" mező az RSS-csatornán annak érdekében, hogy látszódjon a legfrisebb bejegyzés dátuma?');
...
@define('SERENDIPITY_UPGRADER_WELCOME', 'Szia, üdvözöllek a Serendipity frissítő-ugynökénél.');
...
@define('INSTALL_SENDMAIL_DESC', 'Szeretnél levelében értesülni arról, ha egy bejegyzésedhez valaki megjegyzést fűzött?');
@define('INSTALL_SUBSCRIBE', 'Megengeded, hogy mások feliratkozzanak erre a bejegyzésre?');
@define('INSTALL_SUBSCRIBE_DESC', 'Megengeded, hogy mások feliratkozzanak erre a bejegyzésre, azaz levében értesítést kapjanak, ha valaki új megjegyzést fűz hozzá');
