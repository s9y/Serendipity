...
@define('INSTALL_TRACKREF_DESC', 'Wenn das Referrer-Tracking aktiviert wird, werden Verweise auf Ihre Einträge gespeichert. Heutzutage wird dies leider häufig für Spam missbraucht, und kann daher deaktiviert werden.');
