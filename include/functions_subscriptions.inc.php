 ...
 * @param the type of subscription
 *      blog -> all new articles
 *      entry -> new comments to entries (TODO)
 *      author -> new articles from author (TODO)
 *      category -> new articles of a category (TODO)
 * @param the id of the subscripted target (TODO)
